...
echo "========================================"
echo "java -jar /opt/Dev/escola-social-etl/target/etl-1.0-SNAPSHOT.jar --absenteismo"
...
/usr/bin/java -jar /opt/Dev/escola-social-etl/target/etl-1.0-SNAPSHOT.jar --absenteismo
